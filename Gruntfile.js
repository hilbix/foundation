    ...
    uglify: {
      ...
      dist: {
        files: {
          ...
          'dist/docs/assets/js/modernizr.js': ['js/vendor/modernizr.js'],
          'dist/docs/assets/js/all.js': ['js/vendor/lodash.min.js', 'js/vendor/fastclick.js', 'js/vendor/jquery.autocomplete.js', 'js/vendor/jquery.placeholder.js', '<%= foundation.js %>', 'doc/assets/js/docs.js']
        }
      },
      vendor: {
        files: {
